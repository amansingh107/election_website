...
<div class="row my-3">
    <div class="col-4">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                <input type="number" name="number_of_candidates" placeholder="Total Allowed Candidates" class="form-control" required />
            </div>
            <div class="form-group">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Total Allowed Candidates</th>
...
<?php 
    ...
    if(isset($_POST['addElectionBtn']))
    {
        ...
        // inserting into db
        mysqli_query($db, "INSERT INTO election(election_topic, no_of_candidates, starting_date, ending_date, status, inserted_by, inserted_on) VALUES('". $election_topic ."', '". $number_of_candidates ."', '". $starting_date ."', '". $ending_date ."', '". $status ."', '". $inserted_by ."', '". $inserted_on ."')") or die(mysqli_error($db));
