...
<div class="row my-3">
        <div class="col-12">
            ...
            <?php 
                $fetchingVoteDetails = mysqli_query($db, "SELECT * FROM voting WHERE election_id = '". $election_id ."'");
                    ...
                    while($data = mysqli_fetch_assoc($fetchingVoteDetails))
                        {
                            ...
                            $fetchingCandidateName = mysqli_query($db, "SELECT * FROM candidate_detail WHERE id = '". $candidate_id ."'") or die(mysqli_error($db));
